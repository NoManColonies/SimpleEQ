...
template <typename BlockType> struct SingleChannelSampleFifo {
...
struct ChainSettings {
  float peakFreg{0}, peakGainInDecibels{0}, peakQuality{1.f};
  float lowCutFreg{0}, highCutFreg{0};
...
inline auto makeHighCutFilter(const ChainSettings &chainSettings,
  ...
  return juce::dsp::FilterDesign<float>::
      designIIRLowpassHighOrderButterworthMethod(
          chainSettings.highCutFreg, sampleRate,
